...
> открыт. §3 п. 1 (P2/P3/P4/P6/P7/P10) — сделано; п. 2 (P5) — реализовано за `r.FogMS.Transport.PublicHitFlags`, но поле
> отличается на 1,3 % от приватного буфера, дефолт 0 до выяснения (диагностика в работе); п. 4 (атлас без нативного
